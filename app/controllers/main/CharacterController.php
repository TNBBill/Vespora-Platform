...
class CharacterController extends BaseController
{
    ...
    public function edit($id){
        ...
        View::appendVar('jsVar', array('name'=>'edgesAvailable', 'value'=>0));
        View::appendVar('jsVar', array('name'=>'powersAvailable', 'value'=>0));
        View::setVar('statPointsAvailable',5);
        View::setVar('skillPointsAvailable',15);
        View::setVar('edgesAvailable',0);
        View::setVar('powersAvailable',0);
