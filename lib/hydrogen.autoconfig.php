 ...
 ***/
Config::setBasePath($_SERVER['DOCUMENT_ROOT']. DIRECTORY_SEPARATOR . "..");
 ...
 ***  are stored.
 ***/
Config::setVal("view", "folder", "app" . DIRECTORY_SEPARATOR . "views");
...
//Fixed to use existing template files, hopefully not for long.  (Original val ".tpl.php"
