...
abstract class SQLBean {
    ...
    /**
     * function returns the sqlBeans dated (which is stored in the array $stored). Allowing you easly dump the data from
     * the sqlBean into the view without needlessly adding all the other data stored inside the bean to the view.
     *
     * @return array an array of the sqlBean's current data.
     */
